<template>
    <div class="auth-container">
        <div class="auth-box">
            ...
            <p class="auth-signup">
                Don't have an account? <NuxtLink to="/signup" class="auth-link">Sign up here</NuxtLink>
            </p>
        </div>
    </div>
</template>
...
.auth-container {
    @apply flex justify-center items-center min-h-screen bg-gradient-to-r from-purple-200 via-pink-200 to-blue-300;
    .auth-box {
        @apply bg-white p-10 rounded-xl shadow-lg w-96 transform hover:scale-105 transition-transform duration-300 ease-in-out;
    }
    .auth-title {
